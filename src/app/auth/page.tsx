        ...
        <div className="w-full max-w-md p-8 rounded-2xl bg-slate-900/50 border border-slate-800 backdrop-blur-xl shadow-2xl">
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="text-sm text-slate-400 hover:text-indigo-400 font-medium transition duration-150"
            >
              {isLogin ? "Don't have an account? Sign Up" : 'Already configured? Access Login'}
            </button>
          </div>
        </div>
      </div>
